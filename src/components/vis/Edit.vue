        ...
        <div v-for="(it, idx) in maps" :key="idx" class="edit-item" :style="{'border-color': it.locked ? '#e56240': '#e4ae40'}">
          <el-tooltip class="item" effect="light" :disabled="!it.toTip" :content="it.tip" placement="top">
            <div class="prop-box" @click="selectMap($event, it, idx)" :style="{'background-color': it.selected ? '#e4ae40' : 'white'}">
              ...
              <svg v-if="iconType(it.dtype) == 'category'" width="32" height="32" viewBox="0 0 39 39" class="type-icon" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg v-if="iconType(it.dtype) == 'degree'" width="32" height="32" viewBox="0 0 1024 1024" class="type-icon" xmlns="http://www.w3.org/2000/svg">
                <path d="M896 0H128a128 128 0 0 0-128 128v768a128 128 0 0 0 128 128h768a128 128 0 0 0 128-128V128a128 128 0 0 0-128-128z m64 896a64 64 0 0 1-64 64H128a64 64 0 0 1-64-64V128a64 64 0 0 1 64-64h768a64 64 0 0 1 64 64z" p-id="1269"></path>
                <path d="M832 320a32 32 0 0 0 0-64h-192a32 32 0 0 0-32 32V512a32 32 0 0 0 32 32h160V704H640a32 32 0 0 0 0 64h192a32 32 0 0 0 32-32V512a32 32 0 0 0-32-32h-160V320zM384 256H192a32 32 0 0 0-32 32v448a32 32 0 0 0 32 32h192a32 32 0 0 0 32-32v-448A32 32 0 0 0 384 256z m-32 64v384h-128V320z" p-id="1270"></path>
                <path d="M512 736m-32 0a32 32 0 1 0 64 0 32 32 0 1 0-64 0Z" p-id="1271"></path>
              </svg>
              <svg v-if="iconType(it.dtype) == 'number'" width="32" height="32" viewBox="0 0 39 39" class="type-icon" xmlns="http://www.w3.org/2000/svg">
