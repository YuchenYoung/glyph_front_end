...
/**
 * @description SVG任意图形和path路径的面积计算方法
...
export let getPathArea = (function () {

    document.body.insertAdjacentHTML('beforeend', `<svg style="position:absolute;visibility:hidden;"><path id="pathForArea" d=""/></svg>`);
